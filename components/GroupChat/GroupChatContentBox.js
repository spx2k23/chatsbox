...
import ImagePreviewerModal from '../Chat/ImagePreviewerModal';
...
const GroupChatContentBox = ({ messages, currentUserID }) => {
    ...
    const renderMessage = ({ item, index }) => {
        ...
        const isLastMessage = (messages[index + 1] && messages[index + 1].user._id !== item.user._id) || index === messages.length - 1;
        ...
        return (
          ...
          <View style={[styles.senderInfo,isCurrentUser ? styles.rightAligned : styles.leftAligned,{backgroundColor:'#fff'}]}>
            <Image source={{ uri: item.user.avatar }} style={styles.profileImg} />
...
export default GroupChatContentBox;
